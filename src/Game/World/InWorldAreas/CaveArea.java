...
public class CaveArea extends BaseArea {
    ...
    public CaveArea(Handler handler, EntityManager entityManager) {
        ...
        this.entityManager.AddEntity(handler.newEnemy(Images.PEnemyIdle,handler,700, 2000,"InWorldState","Corrupted Pikachu","Cave","EnemyOne",150,25,100,1,8,12,20,10,20,10,1,10,"None","Fire",null,null)); //lvl 2 difficulty
        this.entityManager.AddEntity(handler.newEnemy(Images.PEnemyIdle,handler,3000, 1000,"InWorldState","Cave Dweller","Cave","EnemyOne",100,25,90,10,1,12,20,10,20,13,1,10,"None","Fire",null,null)); // lvl 1 difficulty
